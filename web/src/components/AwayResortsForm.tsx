        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 my-8">
                <div className="p-6 border-b">
                    <h2 className="text-2xl font-bold">Away Resorts Watcher</h2>
                </div>
                <form onSubmit={(e) => { e.preventDefault(); saveMutation.mutate(formData); }} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value={formData.parks} onChange={(e) => setFormData({ ...formData, parks: e.target.value })} className="w-full px-3 py-2 border rounded-md" placeholder="e.g., WHITECLIFF, MILL_RYTHE" />
                    </div>
